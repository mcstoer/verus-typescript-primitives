...
export declare const IDENTITY_UPDATE_RESPONSE_DETAILS_VDXF_KEY: VDXFKeyInterface;
...
export declare const AUTHENTICATION_REQUEST_DETAILS_VDXF_KEY: VDXFKeyInterface;
export declare const AUTHENTICATION_RESPONSE_DETAILS_VDXF_KEY: VDXFKeyInterface;
