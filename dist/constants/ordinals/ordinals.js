...
exports.VDXF_ORDINAL_APP_ENCRYPTION_REQUEST = new bn_js_1.BN(7, 10);
exports.VDXF_ORDINAL_APP_ENCRYPTION_RESPONSE = new bn_js_1.BN(8, 10);
exports.VDXF_ORDINAL_USER_SPECIFIC_DATA_PACKET = new bn_js_1.BN(9, 10);
exports.VDXF_ORDINAL_USER_DATA_REQUEST = new bn_js_1.BN(10, 10);
exports.VDXF_ORDINAL_DATA_RESPONSE = new bn_js_1.BN(11, 10);
