...
export const registerOrdinals = () => {
  ...
  OrdinalVdxfObjectOrdinalMap.registerOrdinal(VDXF_ORDINAL_APP_ENCRYPTION_REQUEST_DETAILS.toNumber(), APP_ENCRYPTION_REQUEST_VDXF_KEY.vdxfid, AppEncryptionRequestOrdinalVdxfObject, false);
