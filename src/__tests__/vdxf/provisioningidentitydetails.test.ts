...
describe('Serializes and deserializes ProvisionIdentityDetails', () => {
    test('(de)serialize ProvisionIdentityDetails', () => {
        ...
        const provisionJson: ProvisionIdentityDetailsJson = {
            ...
            systemid: {version: 1, flags: CompactIdAddressObject.IS_IDENTITYID.toNumber(), address: "iJhCezBExJHvtyH3fGhNnt2NhU4Ztkf2yq", rootsystemname: "VRSC"},
            parentid: {version: 1, flags: CompactIdAddressObject.IS_IDENTITYID.toNumber(), address: "iKjrTCwoPFRk44fAi2nYNbPG16ZUQjv1NB", rootsystemname: "VRSC"}
        }
    ...
    test('(de)serialize ProvisionIdentity with fqn', async () => {
        ...
        const provisionJson = {
            ...
            identityid: {version: 1, flags: CompactIdAddressObject.IS_FQN.toNumber(), address: "my.fully.vrsc@", rootsystemname: "VRSC"}
        }
